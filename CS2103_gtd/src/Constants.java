...
public final class Constants {
	...
	// Formatting
    public static final String DISPLAY_TASK_FORMAT = "%-4d%-7s%-5s%-19s%-19s%s";
    ...
    public static final String DISPLAY_TABLE_HEADERS = String.format("%-4s%-7s%-5s%-19s%-19s%s", "ID", "Status","Done", "    Start Time", "    End Time", "Description");
